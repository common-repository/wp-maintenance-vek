 ...
 * Plugin URI: http://isvek.ru/plug-ins-wordpress/wp-maintenance-vek
...
class WP_Maintenance_vek{
        ...
        if (isset($_POST['action'])){
            if (current_user_can('administrator')){
                if (!empty($_POST) && check_admin_referer('security', 'vekltd')) {
                    ...
                    $this->option['style_background_img_default']   = esc_attr($_POST['style_background_img_default']);
                    ...
                    $this->option['soc']['in']                      = esc_attr($_POST['in']);
                    $this->option['soc']['pinterest']               = esc_attr($_POST['pinterest']);
	...
	public function default_db(){
		...
		'copy'                         => 'isvek.ru',
		'style'                        => array('pink','indigo','blue','teal','green','lime','amber','blue_grey'),
		'style_default'                => 'blue_grey',
        'style_background_img'         => array('none','default','apple'),
        'style_background_img_default' => 'default',
        'cvs'                          => array(),
		'google_analytics'             => '',
		'time_end'                     => __('Время вышло','lang'),
		'roles'                        => array(),
		'soc'                          => array('facebook'=> '','google'=>'','twiter'=>'','vk'=>'','in'=>'','pinterest'=>''));
		return $default;
	}

...
<head>
    ...
    <style>
        ...
        .skins.blue_grey {
            background: <?php
            if($this->option['style_background_img_default'] === 'none')
            {
                        echo'inherit';
            }
            else
            {
                        echo'url('.URL_IMG.$this->option['style_background_img_default'].'.jpg) no-repeat center center fixed !important;
                ...
                <div class="soc">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="socc">
                            ...
                            <?php echo !empty($this->option['soc']['in']) ? '<a href="'.$this->option['soc']['in'].'" class="btn btn-social-icon btn-instagram" TARGET="_blank"><i class="fa fa-instagram"></i></a>':'';?>
                            ...
                            <?php echo !empty($this->option['soc']['pinterest']) ? '<a href="'.$this->option['soc']['pinterest'].'" class="btn btn-social-icon btn-pinterest" TARGET="_blank"><i class="fa fa-pinterest"></i></a>':'';?>
                        </div>
                    </div>
                </div>
            </div>
...
<script type='text/javascript'>
    var countdowntimer = {
        ...
        "skins"       : "<?php echo $this->option['style_default']; ?>"
    };
</script>
